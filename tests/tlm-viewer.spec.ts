...
test('displays INST COMMANDING', async ({ page, utils }) => {
  await showScreen(page, 'INST', 'COMMANDING', async function () {
    // Click on the Type: select ... this was generated by playwright codegen
    await page
      .locator('.d-flex > .v-input > .v-input__control > .v-input__slot')
      .first()
      .click()
    ...
    // Click on the Run Script: select ... this was generated by playwright codegen
    await page
      .locator(
        'div:nth-child(7) > .d-flex > div:nth-child(2) > .v-input__control > .v-input__slot'
      )
      .click()
    await page.getByText('checks.rb').click()
    const [page1] = await Promise.all([
      page.waitForEvent('popup'),
      page.getByRole('button', { name: 'Run Script' }).click(),
    ])
