...
test('handles File->Save new file', async ({ page, utils }) => {
  ...
  // This selector was generated by playwright
  // Basically it means the second div containing a tree containing a button
  // Our tree is alphebetical so EXAMPLE is first, INST is second
  await page
    .locator('div:nth-child(2) > .v-treeview-node__root > button')
    .click()
